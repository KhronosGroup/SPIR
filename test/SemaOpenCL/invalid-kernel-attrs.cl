...
__attribute__((reqd_work_group_size(8,16,32))) void kernel8(){} // expected-error {{'reqd_work_group_size' attribute only applies to kernel functions}}

__attribute__((work_group_size_hint(8,16,32))) void kernel9(){} // expected-error {{'work_group_size_hint' attribute only applies to kernel functions}}

__attribute__((vec_type_hint(char))) void kernel10(){} // expected-error {{'vec_type_hint' attribute only applies to kernel functions}}
